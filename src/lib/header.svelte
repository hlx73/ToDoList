...
<button class="btn variant-filled h-fit w-fit py-4 justify-between bg-violet-400 rounded-full" use:popup={popupCombobox}>
	<span class="" >{comboboxValue }</span>
...
<div class="card w-48 shadow-xl py-2  bg-white" data-popup="popupCombobox">
	<ListBox rounded="rounded-none" active="bg-violet-800">
